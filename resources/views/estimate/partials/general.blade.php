        ...
        <div class="col-md-6">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control form-control-sm initially_empty_datepicker  @php if($errors->has('expiry_date')) { echo 'is-invalid'; } @endphp" name="expiry_date" value="{{ (old_set('expiry_date', NULL,$rec)) ? old_set('expiry_date', NULL,$rec) : "" }}">
