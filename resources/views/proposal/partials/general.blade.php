        ...
        <div class="col-md-6">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control form-control-sm initially_empty_datepicker  @php if($errors->has('open_till')) { echo 'is-invalid'; } @endphp" name="open_till" value="{{ (old_set('open_till', NULL,$rec)) ? old_set('open_till', NULL,$rec) : "" }}">
