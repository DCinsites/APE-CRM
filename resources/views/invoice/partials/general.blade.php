        ...
        <div class="col-md-6">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control form-control-sm initially_empty_datepicker  @php if($errors->has('due_date')) { echo 'is-invalid'; } @endphp" name="due_date" value="{{ (old_set('due_date', NULL,$rec)) ? old_set('due_date', NULL,$rec) : "" }}">
